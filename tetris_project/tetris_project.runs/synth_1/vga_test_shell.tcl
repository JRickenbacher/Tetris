...
read_vhdl -library xil_defaultlib {
  ...
  O:/ENGS31/Final_Project/Tetris/VHDL/vga_test_shell.vhd
}
...
synth_design -top vga_test_shell -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef vga_test_shell.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file vga_test_shell_utilization_synth.rpt -pb vga_test_shell_utilization_synth.pb"
