...
synth_design -top tetris_shell -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef tetris_shell.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file tetris_shell_utilization_synth.rpt -pb tetris_shell_utilization_synth.pb"
