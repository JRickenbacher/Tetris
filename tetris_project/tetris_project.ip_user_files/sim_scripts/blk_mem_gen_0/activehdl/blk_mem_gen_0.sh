...
#
# Generated by Vivado on Sun May 22 00:36:43 -0400 2022
...
# Script info
echo -e "blk_mem_gen_0.sh - Script generated by export_simulation (Vivado v2018.3.1 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="O:/ENGS31/Final_Project/Tetris/tetris_project/tetris_project.cache/compile_simlib/activehdl"
  fi
